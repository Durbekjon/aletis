...
export class CustomerResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Customer username without @',
    example: 'johndoe',
  })
  ...
  @ApiProperty({
    description: 'Bot identifier the customer is tied to',
    example: 12,
  })
  botId: number;
  ...
  @ApiProperty({
    ...
    example: '2027-09-30T10:00:00.000Z',
  })
  createdAt: Date;

  @ApiProperty({
    description: 'Update timestamp',
    example: '2027-09-30T10:05:00.000Z',
  })
  updatedAt: Date;
}
