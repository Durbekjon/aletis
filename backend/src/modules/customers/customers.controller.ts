...
export class CustomersController {
  ...
  @Post(':id/analyze')
  @ApiOperation({ summary: 'Trigger AI analysis for a customer' })
  async analyzeCustomer(
    ...
    const note = await this.customerIntelligenceService.analyzeCustomer(
      id,
      customer.organizationId,
    );
    return note ?? { success: false, message: 'Analysis failed' };
  }
}
