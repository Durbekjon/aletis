 ...
 *
 * gemini-3.6-flash: NOT on the current pricing page — Google has deprecated
 ...
 * hardcode 'gemini-3.6-flash' as a live model string — a deprecated model
...
export const GEMINI_PRICING: Record<string, ModelPricing> = {
  ...
  'gemini-3.6-flash': { inputPerMillion: 0.35, outputPerMillion: 1.05, verified: false },
};
